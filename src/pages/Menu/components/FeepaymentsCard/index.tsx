...
function FeepaymentsCard({ status }: FeepaymentsCardProps) {
  ...
  const [isProgramDetailsMinimized, setIsProgramDetailsMinimized] =
    useState(false);
      ...
      <div>
        <div
          style={{
            ...
            borderRadius: isProgramDetailsMinimized
              ? "12px"
              : "12px 12px 0px 0px",
        ...
        >
          ...
          >
            ...
            <strong style={{ fontSize: "0.875rem", color: "#737373" }}>
              <span>
                <img src={stud} style={{ marginRight: "0.5rem" }} />
              </span>
              Tuviksh Adityas
            </strong>
          </div>

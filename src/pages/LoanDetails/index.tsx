      ...
      <div className={styles.container}>
        <div className={styles.main}>
          <div className={styles.Header} style={{ display: "flex", alignItems: "center" }}>
            ...
            <p style={{ fontSize: "1.4rem", margin: "0 0rem",display:"flex" }}>Loan details <span>
              <p style={{ fontSize: "0.675rem", marginLeft:"0.5rem", padding: "6px 12px", backgroundColor: "#DFF8E4", color: "#45B21E", borderRadius: "16px", fontWeight: "bold" ,position:"fixed",marginRight:"10rem"}}>Active</p></span></p>
          ...
          <div style={{display:"flex",marginTop:"0.75rem"}}>
            <p style={{color:"#5F5F5F",marginRight:"0.5rem",fontSize:"0.875rem"}}><span><img style={{ marginRight: "0.3rem" }} src={calendar} /></span>Loan Closure Date</p>
          ...
          <div style={{padding:"1rem"}}>
              ...
              <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                    <div className={styles.cardNumber}>
                      <p style={{color:"#737373"}}><span><img style={{ marginRight: "0.3rem" ,width:"1.5rem"}} src={ stud} /></span>Beneficiary name </p>
          ...
          <div style={{padding:"1rem"}}>
              ...
              <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                    <div className={styles.cardNumber}>
                      <p style={{color:"#737373"}}><span><img style={{ marginRight: "0.3rem" ,width:"1.5rem"}} src={ cashbag} /></span>Outstanding amount </p>
                      <p className={styles.cardNumberText}>₹ 4,00,000</p>
                    </div>
                    <div style={{display:"flex",marginTop:"0.75rem",flexDirection:"column"}}>
                      <p style={{color:"#5F5F5F",marginRight:"0.5rem",fontSize:"0.875rem"}}><span><img style={{ marginRight: "0.3rem" }} src={calendar} /></span>Loan Closure Date</p>
                      <p className={styles.cardDate}>20/03/2023</p>
                    </div>
                  </div>
                  <div className={styles.cardDetails}>
                    <div>
                      <p className={styles.label}><span><img style={{ marginRight: "0.3rem",width:"1.5rem" }} src={info} /></span>Avail Loan settlement</p>
                    </div>

      ...
      <div className={styles.container}>
        <div className={styles.main}>
          ...
          >
            ...
            <p
              style={{ fontSize: "1.4rem", margin: "0 0rem", display: "flex" }}
            >
              Repayment details
              <span>
                <p
          ...
          <div style={{ marginLeft: "2.75rem" }}>
            <p style={{ fontSize: "0.775rem", color: "#919191" }}>
              Application ID: EL202303010
            </p>
          </div>
          <br />
          <br />
          <div className={styles.principal}>
            <div>
              <p style={{ color: "#606060", marginLeft: "0rem" }}>
                Outstanding amount
              </p>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              Principal amount{" "}
              <span style={{ color: "#d32028" }}>₹ 10,00,000</span>
            </p>
          </div>
          <br />
          <br />
                ...
                <div>
                  <thead>
                    <tr style={{ padding: "10px" }}>
                      <th style={{ width: "4rem", border: "none" }} scope="col">
                        #
                      </th>
                      <th
                        style={{
                  ...
                  <tbody style={{ overflowY: "scroll", height: "10rem" }}>
                    <tr className={styles.tableRow}>
                      ...
                      <td scope="row" style={{ width: "8rem" }}>
                        <img style={{ width: "1.2rem" }} src={info} />
                      </td>
                    </tr>
                    <tr className={styles.tableRow}>
                      <td style={{ padding: "8px" }} scope="row">
